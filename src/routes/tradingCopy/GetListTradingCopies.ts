...
/**
 * @api {post} /trading_copy/get_list_trading_copies 5. Get list trading copies
 * @apiVersion 0.1.0
...
export default (route: Router) =>
  route.post('/get_list_trading_copies', isAuthenticated, new TradingCopyController().getListTradingCopies);
