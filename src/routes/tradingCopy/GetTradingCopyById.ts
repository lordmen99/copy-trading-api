...
/**
 * @api {post} /trading_copy/get_trading_copy_by_id 4. Get trading copy by id
 * @apiVersion 0.1.0
 ...
 *  }
 */
export default (route: Router) => route.post('/get_trading_copy_by_id', new TradingCopyController().getTradingCopyById);
