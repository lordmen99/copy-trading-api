...
/**
 * @api {post} /trading_copy/resume_trading_copy 7. Resume trading copy
 * @apiVersion 0.1.0
 ...
 *  }
 */
export default (route: Router) => route.post('/resume_trading_copy', new TradingCopyController().resumeTradingCopy);
