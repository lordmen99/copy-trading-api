...
/**
 * @api {get} /users/get_user_by_name 8. Get User infor
 * @apiVersion 0.1.0
 * @apiGroup I. Users
 *
 ...
 *  }
 */
export default (route: Router) => route.post('/get_user_by_name', isAuthenticated, new UserController().getUserByName);
