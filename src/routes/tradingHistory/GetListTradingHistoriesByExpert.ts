...
/**
 * @api {post} /trading_history/get_list_trading_histories_by_expert 2. Get list trading histories by expert
 * @apiVersion 0.1.0
...
export default (route: Router) =>
  route.post('/get_list_trading_histories_by_expert', new TradingHistoryController().getListTradingHistoriesByExpert);
