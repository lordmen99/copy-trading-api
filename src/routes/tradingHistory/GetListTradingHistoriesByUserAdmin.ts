...
/**
 * @api {post} /trading_history/get_list_trading_histories_by_user_admin 5. Get list trading histories by user for admin
 * @apiVersion 0.1.0
...
export default (route: Router) =>
  route.post(
    '/get_list_trading_histories_by_user_admin',
    isAuthenticated,
    new TradingHistoryController().getListTradingHistoriesByUserAdmin,
  );
