...
/**
 * @api {post} /experts/update_virtual_copier 11. Update virtual copier
 * @apiVersion 0.1.0
 * @apiGroup II. Experts
 *
 ...
 * @apiParam {Number} total_amount
 * @apiParam {Boolean} is_virtual
 *
 ...
 *  }
 */
export default (route: Router) => route.post('/update_virtual_copier', new ExpertController().updateVirtualCopier);
