...
/**
 * @api {post} /experts/update_range_auto_copier 12. Update range auto copier
 * @apiVersion 0.1.0
 * @apiGroup II. Experts
 *
 ...
 *  }
 */
export default (route: Router) => route.post('/update_range_auto_copier', new ExpertController().updateRangeAutoCopier);
