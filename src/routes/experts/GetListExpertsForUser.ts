...
/**
 * @api {get} /experts/get_list_experts_for_user 9. Get List Experts for user
 * @apiVersion 0.1.0
 * @apiGroup II. Experts
 *
...
export default (route: Router) =>
  route.post('/get_list_experts_for_user', isAuthenticated, new ExpertController().getListExpertsForUser);
