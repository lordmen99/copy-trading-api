...
/**
 * @api {post} /experts/enable_auto_copier 13. Enable auto copier
 * @apiVersion 0.1.0
 * @apiGroup II. Experts
 *
 ...
 *  }
 */
export default (route: Router) => route.post('/enable_auto_copier', new ExpertController().enableAutoCopier);
